...
```
  ...
  /DENSITY ←───┤1 QB  VCC├───── +5V
               │        16│
  /MOTEA   ←───┤2 QC  QA ├───── (ei käytetä / ylimääräinen)
               │        15│
...
```
  ...
  │ port │     ┌────────────────┐                             │           │
  │      │     │   ATmega328P   │     23LC1024      74HC595   │  34-pin   │
  │      │     │                │    ┌────────┐   ┌────────┐  │  IDC      │
  │      │ 1kΩ │                │    │ 128KB  │   │ 8-bit  │  │           │
...
```
  ...
  VCC-GND väliin, mahdollisimman lähelle piirin jalkoja:
    ...
    +5V ──┤├── GND   (23LC1024, pin 8 ja pin 4 väliin)
          100nF
...
```
  ...
  ───  ─────────────────────  ────────────  ───   ────────────────────────
   ...
   2   23LC1024               DIP-8          1   128KB SPI SRAM, 5V
