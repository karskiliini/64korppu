...
> C64:n IEC-sarjaväylä → Arduino Nano + 23LC256 SRAM → PC 3.5" HD floppy

## Yhteenveto

Vaihtoehto D:n parannettu versio. Microchipin 23LC256 SPI SRAM (32 KB) ratkaisee Nanon 2 KB muistirajoituksen. 74HC595 shift register ohjaa floppy-signaaleja SPI-väylän kautta, vapauttaen GPIO-pinnejä. Edelleen täysin 5V-natiivi — ei tasonmuuntimia.
...
| [piirikaavio.md](piirikaavio.md) | 23LC256 + 74HC595 SPI-kytkentä, kokonaispiirikaavio, bypass-kondensaattorit |
...
- **Ei tasonmuuntimia** — 5V natiivi (Nano + 23LC256 + 74HC595 + floppy)
