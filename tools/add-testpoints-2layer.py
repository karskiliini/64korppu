#!/usr/bin/env python3
"""
Add 14 diagnostic test points to the 2-layer PCB.

Same signals as 4-layer version. Positioned along left edge on B.Cu.

Käyttö:
  python3 tools/add-testpoints-2layer.py
"""
import uuid
...
def main():
    ...
    # Check if test points already exist
    if '"TP1"' in content:
        print("Test points already present — skipping")
        return
